<?php
    ...
    class PDF extends FPDF {
        ...
        function OrderTable($orders) {
            ...
            $this->Cell(10, 10, 'U ID', 1);
            $this->Cell(30, 10, 'Name', 1);
            $this->Cell(20, 10, 'P ID', 1);
            $this->Cell(40, 10, 'Product Name', 1);
            $this->Cell(20, 10, 'Price', 1);
            $this->Cell(20, 10, 'Quantity', 1);
            $this->Cell(25, 10, 'Total Price', 1);
            $this->Ln();

            $this->SetFont('Arial', '', 8);
            foreach ($orders as $order) {
                $this->Cell(30, 10, $order['orderid'], 1);
                $this->Cell(10, 10, $order['userid'], 1);
                ...
                $this->Cell(25, 10, $order['totalprice'], 1);
                $this->Ln();
            }
        }
    }
